...
contract('ERC20', function (accounts) {
  ...
  beforeEach(async function () {
    this.tokenFactory = await ShadowFactory.new()
    await this.tokenFactory.mint(initialHolder, '1', initialSupply.toString(), 0x0)
    await this.tokenFactory.deployShadow(1)
    const tokenAddress = await this.tokenFactory.computeShadowAddress(1)
    this.token = await Shadow.at(tokenAddress)
  });
